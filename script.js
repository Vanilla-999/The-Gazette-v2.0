// --- 0. НАСТРОЙКА БЭКЭНДА ---
const API_URL = 'https://rough-fitting-involvement-tiles.trycloudflare.com';
...
async function saveProgressToServer(boardState, score) {
    ...
    try {
        await fetch(`${API_URL}/api/sudoku/progress`, {
            method: 'POST',
            headers: {
...
async function loadProgressFromServer() {
    ...
    try {
        const response = await fetch(`${API_URL}/api/sudoku/progress`, {
